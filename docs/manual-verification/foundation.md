...
- [ ] Grid reads as a Tron-style neon grid — white dividers visible against charcoal, tiles nearly invisible between the lines (phase-goal.md L71).
...
- [ ] Ghost unit (blue) reads as a placeholder — translucent, cyan, positioned on the hovered tile (phase-goal.md L75).
- [ ] Ghost unit (red) reads as a placeholder — translucent, red-orange, positioned on the hovered tile (phase-goal.md L76).
- [ ] Hover tile highlights read as selectable targets in each faction — dim enough not to compete with the ghost, clearly the faction hue (phase-goal.md L83).
...
- [ ] Placed unit (blue) reads as committed — solid, emissive, visibly different from the ghost (phase-goal.md L79).
- [ ] Placed unit (red) reads as committed — solid, emissive, visibly different from the ghost (phase-goal.md L80).
